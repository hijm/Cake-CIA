...
public class Grafico_Venda_Mensal extends HttpServlet {

private static final long serialVersionUID = 1L;
public Grafico_Venda_Mensal() {
...
try {
dataset.executeQuery("select DATE_FORMAT(DataHora,'%m') as Data, sum(Total) as TotalT from venda group by Data");
JFreeChart chart1 = ChartFactory.createBarChart3D("Gráfico de Vendas Mensal", "Mês", "Valor em R$",
